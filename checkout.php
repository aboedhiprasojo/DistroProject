...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Form Checkout Fedzink | Online Shop telengkap dan terpercaya di Pekalongan</title> 
	...
	<div id="wrapper">
		...
		<div class="container">
			...
			<!-- start: Table -->
				...
				<div class="hero-unit">Harap isi form data diri dibawah ini dengan lengkap dan benar sesuai identitas anda!</div>
                <div class="hero-unit">Total Belanjaan Anda adalah Rp. <?php echo abs((int)$_GET['total']); ?>,-</div> 
					<form id="formku" action="selesai.php" method="post">
						<table class="table table-condensed">
							<input type="hidden" name="total" value="<?php echo abs((int)$_GET['total']); ?>">
								...
								<tr>
									<td></td>
									<td><input type="submit" value="Simpan Data" name="finish"  class="btn btn-sm btn-primary"/>&nbsp;<a href="index.php" class="btn btn-sm btn-secondary">Kembali</a></td>
								</tr>
						</table>
					</form>
				</div>
			...
			<div class="row">
				...
				<div class="span2">
					<div id="footer-menu-logo">
						<a href="index.php"><img src="img/Fedzink-Logo.svg" alt="Fedzink-Logo" /></a>
					</div>
				</div>
